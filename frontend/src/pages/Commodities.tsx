          ...
          <div className="p-4 border-b border-slate-100 bg-slate-50/50 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="btn btn-primary bg-emerald-500 hover:bg-emerald-600 border-none text-white btn-xs rounded-lg font-bold px-3 text-xs shadow-sm flex items-center gap-1"
                type="button"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-2">
              <div className="sm:col-span-6 relative">
                ...
                <input
                  ...
                  className="input input-bordered input-xs pl-8 bg-white border-slate-200 focus:outline-none focus:border-emerald-500 text-slate-700 text-xs rounded-lg w-full h-[32px]"
                />
              </div>
              ...
              <div className="sm:col-span-3">
                <select
                  ...
                  className="select select-bordered select-xs bg-white border-slate-200 focus:outline-none focus:border-emerald-500 text-slate-700 text-xs rounded-lg w-full h-[32px]"
                >
          ...
          <div className="overflow-x-auto min-h-[400px] max-h-[650px] overflow-y-auto">
            {loading ? (
              ...
              <table className="table table-compact w-full text-slate-700">
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200/80 text-slate-500 text-xs font-semibold sticky top-0 z-10">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  <label className="w-[140px] text-right pr-3 font-bold text-slate-700 shrink-0 text-xs select-none">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start">
                  <label className="w-[140px] text-right pr-3 font-bold text-slate-700 shrink-0 text-xs select-none pt-2">
                ...
                <div className="space-y-2">
                  {attributes.map((attr, idx) => (
                    <div key={idx} className="flex items-center gap-2">
                      <label className="w-[140px] text-right font-bold text-slate-700 shrink-0 text-xs select-none">
                        Thuộc tính {idx + 1}
                      </label>
                      <input
                        type="text"
