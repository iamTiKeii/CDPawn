    ...
    <header className="navbar bg-white border-b border-slate-200 px-4 py-2 text-slate-800 flex justify-between items-center shadow-sm fixed top-0 left-0 right-0 z-30 h-16">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1 text-xs font-bold text-slate-700 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-lg shadow-sm transition-all ml-2"
          type="button"
