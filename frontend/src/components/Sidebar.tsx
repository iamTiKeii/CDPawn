                  ...
                  {showCapitalManage && (
                    <li>
                      <Link
                        to="/contract/capital"
                        className={`block py-1.5 px-3 text-xs rounded-lg transition-all ${
                          location.pathname === "/contract/capital" ? "text-amber-600 font-medium bg-amber-500/5" : "text-slate-500 hover:text-slate-950 hover:bg-slate-50/80"
                        }`}
                      >
                        Nguồn vốn
                      </Link>
                  ...
                  {hasPermission("COLLABORATORS_MANAGE") && (
                    <li>
                      <Link
                        to="/collaborator"
                        className={`block py-1.5 px-3 text-xs rounded-lg transition-all ${
                          location.pathname === "/collaborator" ? "text-amber-600 font-medium bg-amber-500/5" : "text-slate-500 hover:text-slate-950 hover:bg-slate-50/80"
                        }`}
                      >
                        Cộng tác viên
                      </Link>
