        ...
        <div className="flex items-center gap-3">
          <Link to="/home" className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-slate-400 font-medium tracking-wide">Powered by CDPawn</span>
            </div>
          </Link>
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1 text-xs font-bold border rounded-xl shadow-sm transition-all ml-1 ${
              isCustomerActive
          ...
          >
            <Users className={`w-3.5 h-3.5 ${isCustomerActive ? "text-amber-600" : "text-blue-600"}`} />
                ...
                {showCapitalManage && (
                  <li>
                    <Link
                      to="/contract/capital"
                      className={`flex items-center gap-2.5 py-2 px-3 text-xs rounded-xl transition-all ${
                        path === "/contract/capital" ? "bg-amber-500/10 text-amber-600 font-semibold" : "text-slate-600 hover:text-slate-900 hover:bg-slate-50"
                      }`}
                    >
                ...
                {hasPermission("COLLABORATORS_MANAGE") && (
                  <li>
                    <Link
                      to="/collaborator"
                      className={`flex items-center gap-2.5 py-2 px-3 text-xs rounded-xl transition-all ${
                        path === "/collaborator" ? "bg-amber-500/10 text-amber-600 font-semibold" : "text-slate-600 hover:text-slate-900 hover:bg-slate-50"
                      }`}
                    >
