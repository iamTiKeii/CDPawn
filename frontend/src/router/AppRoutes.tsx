...
const TITLE_MAP: Array<[string, string]> = [
  ["/home", "Trang chủ | CDPawn"],
  ["/dashboard", "Bảng điều khiển | CDPawn"],
  ["/contract/pawn", "Hợp đồng cầm đồ | CDPawn"],
  ["/contract/loan", "Hợp đồng trả góp | CDPawn"],
  ["/contract/installment", "Hợp đồng tín chấp | CDPawn"],
  ["/contracts/pawn/", "Chi tiết Hợp đồng cầm đồ | CDPawn"],
  ["/contracts/unsecured/", "Chi tiết Hợp đồng tín chấp | CDPawn"],
  ["/contracts/installment/", "Chi tiết Hợp đồng trả góp | CDPawn"],
  ["/customer-list", "Danh sách khách hàng | CDPawn"],
  ["/collaborator", "Cộng tác viên | CDPawn"],
  ["/cash-fund", "Quỹ tiền mặt | CDPawn"],
  ["/beginning-cash", "Số dư két đầu ngày | CDPawn"],
  ...
  ["/stores", "Danh sách cửa hàng | CDPawn"],
  ["/shop-list", "Danh sách cửa hàng | CDPawn"],
  ["/employees", "Danh sách nhân viên | CDPawn"],
  ["/staff", "Danh sách nhân viên | CDPawn"],
  ["/staff-permission", "Phân quyền nhân viên | CDPawn"],
  ["/settings", "Cấu hình hệ thống | CDPawn"],
  ["/capital", "Nguồn vốn | CDPawn"],
  ["/summary-report-shop", "Báo cáo thống kê | CDPawn"],
  ["/report-", "Báo cáo thống kê | CDPawn"],
  ["/payment-history", "Báo cáo thống kê | CDPawn"],
  ["/warning/", "Cảnh báo hệ thống | CDPawn"],
  ["/reminders", "Nhắc nhở | CDPawn"],
  ["/terms", "Điều khoản sử dụng | CDPawn"],
  ["/login", "Đăng nhập hệ thống | CDPawn"],
];
...
const TitleUpdater: React.FC = () => {
  ...
  useEffect(() => {
    ...
    document.title = match ? match[1] : "CDPawn - Quản lý cầm đồ";
  }, [location]);
  return null;
};
